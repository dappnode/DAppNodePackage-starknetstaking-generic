...
import { STAKING_MIN_REQUIREMENTS } from './src/config';

export const STAKING_REQUIREMENTS = {
  MAINNET: STAKING_MIN_REQUIREMENTS.MAINNET,
  SEPOLIA: STAKING_MIN_REQUIREMENTS.SEPOLIA,
};

export const Icons = {
  StarknetLogo: () => (
    <svg width="40" height="40" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="512" cy="512" r="512" fill="#0C0C2B"/>
      <path d="M864.5 354.5C780.5 258.5 640.5 238.5 540.5 306.5C440.5 374.5 372.5 498.5 272.5 606.5C172.5 714.5 104.5 782.5 20.5 762.5C112.5 862.5 252.5 882.5 352.5 814.5C452.5 746.5 520.5 622.5 620.5 514.5C720.5 406.5 788.5 338.5 872.5 358.5L864.5 354.5Z" fill="#EC7C67"/>
      <path d="M968.5 458.5C884.5 362.5 744.5 342.5 644.5 410.5C544.5 478.5 476.5 602.5 376.5 710.5C276.5 818.5 208.5 886.5 124.5 866.5C216.5 966.5 356.5 986.5 456.5 918.5C556.5 850.5 624.5 726.5 724.5 618.5C824.5 510.5 892.5 442.5 976.5 462.5L968.5 458.5Z" fill="white"/>
      <path d="M290 240L320 300L380 330L320 360L290 420L260 360L200 330L260 300L290 240Z" fill="white"/>
      <circle cx="750" cy="750" r="55" fill="#EC7C67"/>
    </svg>
  ),
  Wallet: () => (
